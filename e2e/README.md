...
The implemented E2E tests start a local instance of nexus.
...
### Check if the nexus process is running

If you've stopped the tests abruptly, chances are the nexus process is still running on your machine. <br/ >
In order for the tests to function normally, please kill the possible remaining processes using `killall nexus`
